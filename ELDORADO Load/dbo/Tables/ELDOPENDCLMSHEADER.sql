CREATE TABLE [dbo].[ELDOPENDCLMSHEADER] (
    ...
    [CLAIM_INC_DATE]                                                              VARCHAR (50)  NULL,
    [CLAIM_UB92PROC_1]                                                            VARCHAR (50)  NULL,
    [CLAIM_UB92PROC_2]                                                            VARCHAR (50)  NULL,
    [CLAIM_UB92PROC_3]                                                            VARCHAR (50)  NULL,
    [CLAIM_UB92PROC_4]                                                            VARCHAR (50)  NULL,
    [CLAIM_UB92PROC_5]                                                            VARCHAR (50)  NULL,
    [CLAIM_UB92PROC_6]                                                            VARCHAR (50)  NULL,
