...
-- =============================================
CREATE PROCEDURE [dbo].[INSERT_MFELDODISBPAID] 
...
INSERT INTO CLAIMS.DBO.ELDODISBPAIDHEADER(
POLICY_UNDERWRITER
,GROUP_NUMBER
,CLAIM_NUMBER
,EMPLOYEE_SSN
...
,t.PAYMENT_TYPE_2
,t.PAYMENT_TYPE_3
FROM CLAIMS.DBO.MFELDODISBPAID  t
WHERE ASCII(claim_number)<>0;

--ROLLBACK


INSERT INTO CLAIMS.DBO.ELDODISBPAIDLINES (
  POLICY_UNDERWRITER
, GROUP_NUMBER
, CLAIM_NUMBER
, EMPLOYEE_SSN
...
, IIF(LEN(LTRIM(RTRIM(SUBSTRING(service_line_information_2,276,1)))) = 0,NULL,SUBSTRING(service_line_information_2,276,1))
 FROM claims.dbo.ELDODISBPAIDHEADER
...
, IIF(LEN(LTRIM(RTRIM(SUBSTRING(service_line_information_4,276,1)))) = 0,NULL,SUBSTRING(service_line_information_4,276,1))
 ...
 DELETE FROM CLAIMS.DBO.ELDODISBPAIDLINES where BENEFIT_CODE is NULL;
