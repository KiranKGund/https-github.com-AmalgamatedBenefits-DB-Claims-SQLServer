...
-- =============================================
CREATE PROCEDURE [dbo].[UPDATE_MFELDOMCSCLMLINESNEW] 
...
UPDATE [CLAIMS].[DBO].[MFELDOMCSCLMLINESNEW]
SET		DATE_FROM =	FORMAT(CONVERT(Date,CAST(IIF(ISDATE(DATE_FROM)=1,DATE_FROM,'19000101') as Date), 101),'yyyyMMdd'),
		DATE_TO =	FORMAT(CONVERT(Date,CAST(IIF(ISDATE(DATE_TO)=1,DATE_TO,'19000101') as Date), 101),'yyyyMMdd')
