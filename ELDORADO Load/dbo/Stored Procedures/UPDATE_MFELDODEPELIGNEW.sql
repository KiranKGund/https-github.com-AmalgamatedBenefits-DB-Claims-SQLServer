...
-- =============================================
CREATE PROCEDURE [dbo].[UPDATE_MFELDODEPELIGNEW] 
...
UPDATE CLAIMS.DBO.MFELDODEPELIGNEW
SET 
EFFECTIVE_DATE_OF_ELIGIBILITY = FORMAT(CONVERT(Date,CAST(IIF(ISDATE(EFFECTIVE_DATE_OF_ELIGIBILITY)=1,EFFECTIVE_DATE_OF_ELIGIBILITY,'19000101') as Date), 101),'yyyyMMdd'),
COVERAGE_ENDS_DATE = FORMAT(CONVERT(Date,CAST(IIF(ISDATE(COVERAGE_ENDS_DATE)=1,COVERAGE_ENDS_DATE,'19000101') as Date), 101),'yyyyMMdd')
